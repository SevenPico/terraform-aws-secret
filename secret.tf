...
locals {
  enable_kms_key = module.context.enabled && length(var.kms_key_id) == 0 ? 0 : 1
...
resource "aws_secretsmanager_secret" "this" {
  ...
  kms_key_id  = local.enable_kms_key ? module.kms_key[0].key_id : var.kms_key_id
